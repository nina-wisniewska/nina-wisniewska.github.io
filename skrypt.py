...
if table:
    ...
    for row in rows:
        ...
        if len(cols) >= 2:
            ...
            languages.append({"Position": position, "Language": language, "Ratings": ratings, "Previous": previous, "Image": img_url})
else:
...
with open("index.md", "w", encoding="utf-8") as file:
    ...
    file.write("This project provides the latest programming language rankings based on the TIOBE Index of popularity.\n\n")
    file.write("You can view the full list of languages here:\n\n")
    file.write("[View Programming Popularity Language Rankings](tiobe_index.md)\n")
...
with open("tiobe_index.md", "w", encoding="utf-8") as file:
    ...
    for item in languages:
        ...
        file.write("Ratings: " + item['Ratings'] + "\n\n")
        file.write("Previous month position: " + item['Previous'] + "\n\n")
            ...
            with open(lang_filename, "w", encoding="utf-8") as lang_file:
                ...
                for i, url in enumerate(results):
                    ...
                    if description and len(description.text.strip()) > length_min:
                        lang_file.write(description.text.strip())
                        lang_file.write("\n\n")
                    else:
                        continue
